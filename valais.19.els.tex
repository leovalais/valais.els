...
Common Lisp standard \cite{bib:ansi.94.cl} and roughly summarized in table
\ref{tab:ts}\footnote{More type specifiers exist. We do not describe them here either
...
Section \ref{sec:numconv}, ensures the representation (in term of type specifiers) of
