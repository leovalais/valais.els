...
\begin{abstract}
  ...
  implementation. But he did not provide any serious implementation and his
  description is sometimes obscure. In this paper we present our implementation
  of half of his procedure, only supporting primitive types, \textsc{Clos}
  ...
  of his description and fill some of its gaps or omissions.
  We also argument in favor and against some of his choices and present our
  alternative solutions. We also provide some proofs that might
...
two type specifiers describe in fact the same using two calls of
\code{subtypep}.
