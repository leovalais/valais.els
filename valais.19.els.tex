...
involves a \code{satisfies} type specifier.
...
The type specifier Domain-Specific Language (DSL) allows the programmer to
...
\begin{description}[leftmargin=8em,style=nextline]
  ...
  \item[type $\approx$ t.s.] When no confusion is possible we allow ourselves to
  ...
  \item[$T \subseteq T'$] The \emph{type} $T$ is a non-strict subtype of $T'$.
