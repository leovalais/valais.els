...
and \cite{newton.18.els}.
\textbf{TODO}

Our implementation is still in active development and currently targets
\sbcl{} and focuses almost entirely on results accuracy. It supports
primitive types, user-defined types (\code{deftype}, classes and structures),
\code{member} (and \code{eql}) type specifiers and ranges (e.g.,
