...
First, anytime $\Gamma$ encounters or returns a union, it must ensure that it is
...
\newcommand\jimgraph[1]{\scalebox{\jimscale}{\input{assets/19/#1}}}

\begin{figure}
  \centering
  \renewcommand\jimscale{0.5}
  \begin{tabular}{cc}
    \jimgraph{big-member-smooth.ltxdat} % integer ranges
    &\jimgraph{big-member-smooth.ltxdat} % subtypes of number
  \end{tabular}
...
\begin{figure}
  ...
  \renewcommand\jimscale{0.5}
  \begin{tabular}{cc}
    \jimgraph{big-member-smooth.ltxdat} % subtypes of t
    &\jimgraph{big-member-smooth.ltxdat} % subtypes of condition
  \end{tabular}
...
bit-vector grow quickly, thus making every subsequent operation slower.
